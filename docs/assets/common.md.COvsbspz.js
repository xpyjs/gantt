import{_ as s,o as i,c as a,am as n}from"./chunks/framework.BZbxhP-o.js";const c=JSON.parse('{"title":"通用方法","description":"","frontmatter":{},"headers":[],"relativePath":"common.md","filePath":"common.md","lastUpdated":1718588791000}'),l={name:"common.md"},p=n(`<h1 id="通用方法" tabindex="-1">通用方法 <a class="header-anchor" href="#通用方法" aria-label="Permalink to &quot;通用方法&quot;">​</a></h1><h2 id="日期格式化属性" tabindex="-1">日期格式化属性 <a class="header-anchor" href="#日期格式化属性" aria-label="Permalink to &quot;日期格式化属性&quot;">​</a></h2><p>格式化对接了 <code>dayjs</code>，详看 <a href="https://dayjs.gitee.io/docs/zh-CN/display/format" target="_blank" rel="noreferrer">dayjs</a>。</p><h3 id="多语言" tabindex="-1">多语言 <a class="header-anchor" href="#多语言" aria-label="Permalink to &quot;多语言&quot;">​</a></h3><p><strong>更新版本 <code>v2.1.1</code></strong></p><p>现在通过 <code>locale</code> 参数可以设置多语言。</p><p>支持的语言列表：</p><div class="language-js vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">am</span></span>
