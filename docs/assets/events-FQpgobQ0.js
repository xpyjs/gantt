...
const eventManager = new GanttEventManager(gantt);`},t={overview:{title:"事件概述",description:"甘特图组件提供了丰富的事件监听机制，可以监听用户的各种操作行为。所有事件都通过 on 方法进行监听，事件触发时会传递相关的数据参数，方便开发者根据用户行为执行相应的业务逻辑。",examples:[{framework:"javascript",code:e.basicUsage,language:"javascript"}]},categories:[{id:"task-events",title:"任务相关事件",icon:"📋",description:"用户与任务进行交互时触发的事件",events:[{id:"select",name:"select",type:"选择状态变化",description:"当任务的选择状态发生变化时触发",trigger:"当任务的选择状态发生变化时",parameters:[{name:"data",type:"any[]",description:"当前操作的任务数据数组"},{name:"checked",type:"boolean",description:"选择状态（true=选中，false=取消选中）"},{name:"all",type:"any[]",description:"所有已选中的任务数据数组"}],examples:[{framework:"javascript",code:e.selectEvent,language:"javascript"}]},{id:"click:row",name:"click:row",type:"行点击",description:"用户单击任务行时触发",trigger:"用户单击任务行时",parameters:[{name:"e",type:"MouseEvent",description:"鼠标事件对象"},{name:"data",type:"any",description:"被点击行的任务数据"}],examples:[{framework:"javascript",code:e.clickRowEvent,language:"javascript"}]},{id:"dblclick:row",name:"dblclick:row",type:"行双击",description:"用户双击任务行时触发",trigger:"用户双击任务行时",parameters:[{name:"e",type:"MouseEvent",description:"鼠标事件对象"},{name:"data",type:"any",description:"被双击行的任务数据"}],notes:["双击事件会多次触发鼠标点击"],examples:[{framework:"javascript",code:e.dblclickRowEvent,language:"javascript"}]},{id:"contextmenu:row",name:"contextmenu:row",type:"行右键菜单",description:"用户在任务行上右键点击时触发",trigger:"用户在任务行上右键点击时",parameters:[{name:"e",type:"MouseEvent",description:"鼠标事件对象"},{name:"data",type:"any",description:"被右键点击行的任务数据"}],examples:[{framework:"javascript",code:e.contextmenuRowEvent,language:"javascript"}]},{id:"click:slider",name:"click:slider",type:"任务条点击",description:"用户单击任务条时触发",trigger:"用户单击任务条时",parameters:[{name:"e",type:"MouseEvent",description:"鼠标事件对象"},{name:"data",type:"any",description:"被点击任务条的数据"}],examples:[{framework:"javascript",code:e.clickSliderEvent,language:"javascript"}]},{id:"dblclick:slider",name:"dblclick:slider",type:"任务条双击",description:"用户双击任务条时触发",trigger:"用户双击任务条时",parameters:[{name:"e",type:"MouseEvent",description:"鼠标事件对象"},{name:"data",type:"any",description:"被双击任务条的数据"}],notes:["双击事件会多次触发鼠标点击"],examples:[{framework:"javascript",code:e.dblclickSliderEvent,language:"javascript"}]},{id:"contextmenu:slider",name:"contextmenu:slider",type:"任务条右键菜单",description:"用户在任务条上右键点击时触发",trigger:"用户在任务条上右键点击时",parameters:[{name:"e",type:"MouseEvent",description:"鼠标事件对象"},{name:"data",type:"any",description:"被右键点击任务条的数据"}],examples:[{framework:"javascript",code:e.contextmenuSliderEvent,language:"javascript"}]},{id:"move",name:"move",type:"任务移动",description:"用户拖拽移动任务时间时触发",trigger:"用户拖拽移动任务时间时",parameters:[{name:"data",type:"{ row: any; old: any }[]",description:"移动的任务数据数组"}],notes:["移动时，XGantt 内部已经更新了数据，所以数据源已经是新数据。如果需要撤销本次移动，请使用 old 数据进行相应替换，并更新视图。"],examples:[{framework:"javascript",code:e.moveEvent,language:"javascript"}]},{id:"hover:slider",name:"hover:slider",type:"任务条悬停",description:"鼠标悬停在任务条上时触发",trigger:"鼠标悬停在任务条上时",parameters:[{name:"e",type:"MouseEvent",description:"鼠标事件对象"},{name:"data",type:"any",description:"悬停的任务数据"}],examples:[{framework:"javascript",code:e.hoverSliderEvent,language:"javascript"}]},{id:"leave:slider",name:"leave:slider",type:"任务条离开",description:"鼠标离开任务条时触发",trigger:"鼠标离开任务条时",parameters:[{name:"e",type:"MouseEvent",description:"鼠标事件对象"},{name:"data",type:"any",description:"离开的任务数据"}],examples:[{framework:"javascript",code:e.leaveSliderEvent,language:"javascript"}]},{id:"click:baseline",name:"click:baseline",type:"基线点击",description:"用户单击基线时触发",trigger:"用户单击基线时",parameters:[{name:"e",type:"MouseEvent",description:"鼠标事件对象"},{name:"task",type:"any",description:"任务数据"},{name:"baseline",type:"any",description:"基线数据"}],examples:[{framework:"javascript",code:e.clickBaselineEvent,language:"javascript"}]},{id:"contextmenu:baseline",name:"contextmenu:baseline",type:"基线右键菜单",description:"用户在基线上右键点击时触发",trigger:"用户在基线上右键点击时",parameters:[{name:"e",type:"MouseEvent",description:"鼠标事件对象"},{name:"task",type:"any",description:"任务数据"},{name:"baseline",type:"any",description:"基线数据"}],examples:[{framework:"javascript",code:e.contextmenuBaselineEvent,language:"javascript"}]},{id:"hover:baseline",name:"hover:baseline",type:"基线悬停",description:"鼠标悬停在基线上时触发",trigger:"鼠标悬停在基线上时",parameters:[{name:"e",type:"MouseEvent",description:"鼠标事件对象"},{name:"task",type:"any",description:"任务数据"},{name:"baseline",type:"any",description:"基线数据"}],examples:[{framework:"javascript",code:e.hoverBaselineEvent,language:"javascript"}]},{id:"leave:baseline",name:"leave:baseline",type:"基线离开",description:"用户离开基线时触发",trigger:"用户离开基线时",parameters:[{name:"e",type:"MouseEvent",description:"鼠标事件对象"},{name:"task",type:"any",description:"任务数据"},{name:"baseline",type:"any",description:"基线数据"}],examples:[{framework:"javascript",code:e.leaveBaselineEvent,language:"javascript"}]}]},{id:"link-events",title:"依赖关系事件",icon:"🔗",description:"用户操作任务依赖关系时触发的事件",events:[{id:"create:link",name:"create:link",type:"创建依赖关系",description:"用户创建新的任务依赖关系时触发",trigger:"用户创建新的任务依赖关系时",parameters:[{name:"linkData",type:"ILink",description:"新创建的依赖关系数据"}],notes:["依赖关系需要手动更新数据"],examples:[{framework:"javascript",code:e.createLinkEvent,language:"javascript"}]},{id:"update:link",name:"update:link",type:"更新依赖关系",description:"依赖关系被修改时触发",trigger:"依赖关系被修改时",parameters:[{name:"linkData",type:"ILink",description:"更新后的依赖关系数据"}],notes:["依赖关系需要手动更新数据"],examples:[{framework:"javascript",code:e.updateLinkEvent,language:"javascript"}]},{id:"select:link",name:"select:link",type:"选择依赖关系",description:"用户点击选择或取消选择依赖关系线时触发",trigger:"用户点击选择或取消选择依赖关系线时",parameters:[{name:"add",type:"ILink | null",description:"新增选择的依赖关系（如果有）"},{name:"cancel",type:"ILink | null",description:"取消选择的依赖关系（如果有）"},{name:"all",type:"ILink[]",description:"当前所有选中的依赖关系数组"}],notes:["依赖关系需要手动更新数据"],examples:[{framework:"javascript",code:e.selectLinkEvent,language:"javascript"}]},{id:"contextmenu:link",name:"contextmenu:link",type:"依赖关系右键菜单",description:"用户在依赖关系线上右键点击时触发",trigger:"用户在依赖关系线上右键点击时",parameters:[{name:"e",type:"MouseEvent",description:"鼠标事件对象"},{name:"linkData",type:"ILink",description:"被右键点击的依赖关系数据"}],examples:[{framework:"javascript",code:e.contextMenuLinkEvent,language:"javascript"}]}]},{id:"system-events",title:"系统事件",icon:"⚠️",description:"系统状态变化或错误时触发的事件",events:[{id:"loaded",name:"loaded",type:"组件加载完成",description:"甘特图组件完全加载并初始化完成时触发",trigger:"甘特图组件完全加载并初始化完成时",parameters:[],notes:["此事件在甘特图实例完全准备就绪后触发","可以在此事件之后执行需要对甘特图实例的操作","该事件只会触发一次"],examples:[{framework:"javascript",code:e.loadedEvent,language:"javascript"}]},{id:"error",name:"error",type:"错误处理",description:"甘特图组件发生错误时触发",trigger:"甘特图组件发生错误时",parameters:[{name:"error",type:"ErrorType",description:"错误类型"}],notes:["ErrorType 错误类型：","LINK_NOT_ALLOWED - 连线不被允许","LINK_SAME - 相同节点","LINK_EXIST - 当前关联已存在"],examples:[{framework:"javascript",code:e.errorEvent,language:"javascript"}]}]}],bestPractices:[{id:"event-handling",title:"事件处理建议",icon:"💡",content:["在事件处理函数中避免执行耗时操作，必要时使用防抖或节流","及时清理事件监听器，避免内存泄漏","在移动和创建/更新依赖关系事件中，记得同步更新数据源","合理利用错误事件提供用户友好的错误提示"]},{id:"performance",title:"性能优化",icon:"⚡",content:["对于频繁触发的事件（如鼠标移动），考虑使用节流","批量处理数据更新，避免频繁调用 update","在大数据量场景下，考虑异步处理事件回调"]},{id:"data-sync",title:"数据同步",icon:"🔄",content:["在任务移动事件中及时更新数据源，保持界面与数据一致","在依赖关系事件中正确处理数据的增删改，避免重复或遗漏","考虑实现乐观更新，提升用户体验"]}],completeExamples:[{framework:"javascript",code:e.completeExample,language:"javascript"},{framework:"vue",code:e.vueEvents,language:"vue"},{framework:"react",code:e.reactEvents,language:"tsx"}]};export{t as e};
