import{_ as i,r as a,o as l,c as d,b as n,d as s,a as r,f as v,e as c}from"./app.e1d55119.js";const o={},m=n("h1",{id:"通用方法",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#通用方法","aria-hidden":"true"},"#"),s(" 通用方法")],-1),t=n("h2",{id:"日期格式化属性",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#日期格式化属性","aria-hidden":"true"},"#"),s(" 日期格式化属性")],-1),u=n("code",null,"dayjs",-1),b={href:"https://dayjs.gitee.io/docs/zh-CN/display/format",target:"_blank",rel:"noopener noreferrer"},p=n("h3",{id:"多语言",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#多语言","aria-hidden":"true"},"#"),s(" 多语言")],-1),k=c(`<p><strong>更新版本 <code>v2.1.1</code></strong></p><p>现在通过 <code>locale</code> 参数可以设置多语言。</p><p>支持的语言列表：</p><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code>am
