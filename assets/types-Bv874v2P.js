const t={XGanttUnit:'export type XGanttUnit = "hour" | "day" | "week" | "month" | "quarter";',ScaleUnitMain:`/**
 * 自定义时间轴刻度配置
 * 元组约束：仅最后一项（底层 scale）允许设置 cellWidth
 */
export type ScaleUnit = [...IScaleConfigBase[], IScaleConfigBottom];`,ScaleUnitExtra:`/** 所有支持的时间刻度单位 */
...
/** 单层时间轴刻度配置 */
export type IScaleConfig = IScaleConfigBase | IScaleConfigBottom;`,IOptionConfig:`export type IOptionConfig = {
  /** 是否合并选项 */
  merge?: boolean;
...
}`},e={overview:{title:"类型概述",description:"这里列出了在使用 Gantt 组件进行二次开发时最常用的一些公共 TypeScript 类型。所有内容直接来自核心库的 d.ts 声明文件，保证与源码保持一致，便于查阅与复制。"},types:[{id:"DataChain",name:"DataChain",description:"以某任务为中心计算得到的完整前置/后置链路集合。用于依赖可视分析。",code:[{framework:"javascript",code:t.DataChain,language:"typescript"}]},{id:"EmitData",name:"EmitData",description:"事件/回调传出的任务基础结构封装，包含原始数据及层级索引。",code:[{framework:"javascript",code:t.EmitData,language:"typescript"}]},{id:"ILink",name:"ILink",description:"任务间依赖（连线）基础结构。包含起止任务及连线类型等。",code:[{framework:"javascript",code:t.ILink,language:"typescript"}]},{id:"IOptionConfig",name:"IOptionConfig",description:"更新配置时的附加选项，目前支持是否合并更新。",code:[{framework:"javascript",code:t.IOptionConfig,language:"typescript"}]},{id:"LinkType",name:"LinkType",description:"四种依赖类型组合（FS/FF/SS/SF），定义连线在起止任务的锚点位置。",code:[{framework:"javascript",code:t.LinkType,language:"typescript"}]},{id:"ScaleUnit",name:"ScaleUnit",description:"自定义时间轴刻度配置。元组约束确保仅底层（最后一项）可设置 cellWidth。",code:[{framework:"javascript",code:t.ScaleUnitMain,language:"typescript"}],extraDescription:"详细配置类型如下：",extraCode:[{framework:"javascript",code:t.ScaleUnitExtra,language:"typescript"}]},{id:"XGanttUnit",name:"XGanttUnit",description:"甘特图时间刻度单位类型。控制时间轴的粒度。",code:[{framework:"javascript",code:t.XGanttUnit,language:"typescript"}]}]};export{e as t};
