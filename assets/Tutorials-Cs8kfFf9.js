import{d as G,i as I,o as i,c as r,t as m,f,F as k,r as w,a as d,e as x,j as T,k as X,l as A,u as D,m as R,n as E,p as U,q as M,_ as O}from"./main-lfjL1JTW.js";const y=70,_="  ",v=(t,u,l)=>{if(t===null)return"null";if(t===void 0)return"undefined";if(typeof t=="string")return`'${t}'`;if(["number","boolean","bigint"].includes(typeof t))return String(t);if(typeof t=="symbol")return t.toString();if(typeof t=="function"){const p=t.toString();return p.includes("[native code]")?`function ${t.name}() { [native code] }`:p}if(typeof t=="object"){if(l.has(t))return"'[Circular]'";l.add(t);const p=_.repeat(u),g=_.repeat(u+1);if(t instanceof Error)return l.delete(t),`new Error('${t.message}')`;if(t instanceof Date)return l.delete(t),`new Date('${t.toISOString()}')`;if(t instanceof RegExp)return l.delete(t),t.toString();let c;if(Array.isArray(t))if(t.length===0)c="[]";else{const s=t.map(a=>v(a,u+1,l)),n=`[${s.join(", ")}]`;c=n.length<=y?n:`[
${s.map(a=>`${g}${a}`).join(`,
`)}
${p}]`}else if(t instanceof Map)if(t.size===0)c="new Map()";else{const s=Array.from(t.entries()).map(([a,e])=>`[${v(a,u+1,l)}, ${v(e,u+1,l)}]`),n=`new Map([${s.join(", ")}])`;c=n.length<=y?n:`new Map([
${s.map(a=>`${g}${a}`).join(`,
`)}
${p}])`}else if(t instanceof Set)if(t.size===0)c="new Set()";else{const s=Array.from(t.values()).map(a=>v(a,u+1,l)),n=`new Set([${s.join(", ")}])`;c=n.length<=y?n:`new Set([
${s.map(a=>`${g}${a}`).join(`,
`)}
${p}])`}else{const s=Object.keys(t);if(s.length===0)c="{}";else{const n=s.map(e=>{const o=/^[a-zA-Z_$][a-zA-Z0-9_$]*$/.test(e)?e:`'${e}'`,h=v(t[e],u+1,l);return{keyStr:o,valStr:h}}),a=`{ ${n.map(e=>`${e.keyStr}: ${e.valStr}`).join(", ")} }`;a.length<=y?c=a:c=`{
...
export default App`,b={jsCode:B,vueCode:F,reactCode:V},L=`<!-- Vue 组件中使用 -->
<template>
  <div>
    <XGanttVue
...
`,C={vueCode:L,reactCode:N,angularCode:P},$=[{id:"quick-start",title:"快速入门",sections:[{id:"installation",title:"安装",description:"XGantt 支持多种安装方式，你可以根据项目需求选择合适的包。",subsections:[{title:"核心包",code:[{framework:"vue",code:"npm install @xpyjs/gantt-vue",language:"bash"},{framework:"react",code:"npm install @xpyjs/gantt-react",language:"bash"},{framework:"javascript",code:"npm install @xpyjs/gantt-core",language:"bash"}]}]},{id:"basic-usage",title:"基础用法",description:"以下是不同框架下的基础使用方法：",code:[{framework:"vue",code:b.vueCode,language:"vue"},{framework:"react",code:b.reactCode,language:"tsx"},{framework:"javascript",code:b.jsCode,language:"javascript"}],customContent:'这样在浏览器中就可以看到效果了。想要实践一下，去 <a href="/demo/basic/simple">演示广场</a> 试试吧。'},{id:"data-structure",title:"数据结构",description:"数据结构应当保证有唯一 id。如果需要展示时间进度等信息，需要添加对应字段。这些字段都可以通过 fields 来自定义。",subsections:[{title:"基础数据结构",code:[{framework:"javascript",code:`const data = [
  {
    id: '1',                    // 唯一标识
    name: '项目规划',            // 任务名称
...
}`,language:"javascript"}]},{description:"渲染的内容如下图，可以看到表头、任务条、周末、假期等自定义后的显示效果："},{customContent:'<img src="/tutorials-custom-axis.png" />'}]},{id:"frameworks",title:"框架集成",description:"XGantt 可以很方便的集成到各种框架中。并且 XGantt 已经自带 vue 与 react 的框架",subsections:[{title:"Vue 集成",code:[{framework:"vue",language:"vue",code:C.vueCode},{framework:"react",language:"tsx",code:C.reactCode},{framework:"angular",language:"ts",code:C.angularCode}]}]},{id:"performance",title:"性能优化",description:"为了确保在大数据量下的流畅体验，XGantt 内置了多种性能优化策略。在多数情况，用户不用关心也不必担心性能问题，但是用户仍然可以通过编码使其更加优秀。",subsections:[{list:["**确保数据唯一键**：尽可能给每条数据添加唯一 ID，这会让 XGantt 处理数据更加高效","**只更新需要的内容**：尽可能不要每次全量更新 options，当数据没有变化时，不要传递它","**拖拽功能**：拖拽是一个耗时操作，非必要不开启，尽量启用按单位拖拽（byUnit）",'**依赖关系**：依赖关系是一个十分消耗性能的渲染功能，尽可能避免使用虚线绘制，具体可以查看 <a href="/tutorials#依赖关系的性能问题">依赖关系的性能问题</a>']}]}]}],H=()=>{const t=[];return $.forEach(u=>{t.push({id:u.id,title:u.title,sections:u.sections.map(l=>({id:l.id,title:l.title}))})}),t},z={class:"tutorial-content"},Y={key:0,class:"section-description"},W=["id"],q={key:1,class:"subsection-description"},K={key:2,class:"content-list"},Z=["innerHTML"],J={key:3,class:"config-table"},Q=["innerHTML"],tt=["innerHTML"],et=G({__name:"TutorialSection",props:{section:{}},setup(t){const u=I(),l=c=>{let s=c.replace(/`([^`]+)`/g,"<code>$1</code>");return s=s.replace(/\*\*([^*]+)\*\*/g,"<strong>$1</strong>"),p(s)},p=c=>{if(!c)return"";const s="/gantt/";let n=c.replace(/href="(\/[^"]*)"/g,(a,e)=>{const o=s.replace(/\/$/,""),h=e.startsWith("/")?e:`/${e}`;return`href="${o}${h}"`});return n=n.replace(/src="(\/[^"]*)"/g,(a,e)=>{const o=s.replace(/\/$/,""),h=e.startsWith("/")?e:`/${e}`;return`src="${o}${h}"`}),n},g=c=>{const s=c.target;if(s.tagName==="A"){const n=s.getAttribute("href");if(n){const a=new URL(n,window.location.origin);if(a.origin===window.location.origin){c.preventDefault();const e="/gantt/";let o=a.pathname;o.startsWith(e)&&(o=o.substring(e.length)),u.push(o+a.search+a.hash)}}}};return(c,s)=>(i(),r("div",z,[t.section.description?(i(),r("p",Y,m(t.section.description),1)):f("",!0),t.section.subsections?(i(!0),r(k,{key:1},w(t.section.subsections,(n,a)=>(i(),r("div",{key:a,class:"subsection"},[n.title?(i(),r("h3",{key:0,class:"subsection-title",id:n.title},m(n.title),9,W)):f("",!0),n.description?(i(),r("p",q,m(n.description),1)):f("",!0),n.list?(i(),r("ul",K,[(i(!0),r(k,null,w(n.list,(e,o)=>(i(),r("li",{key:o,innerHTML:l(e)},null,8,Z))),128))])):f("",!0),n.table?(i(),r("div",J,[d("table",null,[d("thead",null,[d("tr",null,[(i(!0),r(k,null,w(n.table.headers,e=>(i(),r("th",{key:e},m(e),1))),128))])]),d("tbody",null,[(i(!0),r(k,null,w(n.table.rows,e=>(i(),r("tr",{key:e.property},[d("td",null,[d("code",null,m(e.property),1)]),d("td",null,m(e.type),1),d("td",null,m(e.default),1),d("td",null,m(e.description),1)]))),128))])])])):f("",!0),n.code?(i(),x(T,{key:4,codeBlocks:n.code},null,8,["codeBlocks"])):f("",!0),n.customContent?(i(),r("div",{key:5,innerHTML:p(n.customContent),class:"custom-content",onClick:g},null,8,Q)):f("",!0)]))),128)):f("",!0),t.section.code?(i(),x(T,{key:2,codeBlocks:t.section.code},null,8,["codeBlocks"])):f("",!0),t.section.customContent?(i(),r("div",{key:3,innerHTML:p(t.section.customContent),class:"custom-content",onClick:g},null,8,tt)):f("",!0)]))}}),nt={class:"tutorials-page"},at={class:"tutorials-content"},ot={class:"tutorials-sidebar"},it={class:"tutorials-nav"},rt=["href","onClick"],st={class:"category-title"},lt=["id"],ct=G({__name:"Tutorials",setup(t){const u=H(),l=M(""),p=(n,a)=>{let e;return(...o)=>{clearTimeout(e),e=setTimeout(()=>n.apply(null,o),a)}},g=()=>{const n=[];return $.forEach(a=>{a.sections.forEach(e=>{n.push(e.id)})}),n},c=p(()=>{const n=g(),a=150;for(let e=n.length-1;e>=0;e--){const o=document.getElementById(n[e]);if(o&&o.getBoundingClientRect().top<=a){l.value=n[e];break}}},100),s=n=>{const a=document.getElementById(n);if(a){const h=a.offsetTop-80;window.scrollTo({top:h,behavior:"smooth"}),l.value=n}};return X(()=>{window.addEventListener("scroll",c,{passive:!0}),c()}),A(()=>{window.removeEventListener("scroll",c)}),(n,a)=>(i(),r("div",nt,[a[0]||(a[0]=d("header",{class:"page-header"},[d("div",{class:"container"},[d("h1",null,"教程文档"),d("p",null,"深入学习 XGantt 的各种功能和 API")])],-1)),d("div",at,[d("aside",ot,[d("nav",it,[(i(!0),r(k,null,w(D(u),e=>(i(),r("div",{key:e.id,class:"nav-section"},[d("h3",null,m(e.title),1),d("ul",null,[(i(!0),r(k,null,w(e.sections,o=>(i(),r("li",{key:o.id},[d("a",{href:`#${o.id}`,class:E({active:l.value===o.id}),onClick:R(h=>s(o.id),["prevent"])},m(o.title),11,rt)]))),128))])]))),128))])]),d("main",null,[(i(!0),r(k,null,w(D($),e=>(i(),r("section",{key:e.id,class:"tutorials-main"},[d("h1",st,m(e.title),1),(i(!0),r(k,null,w(e.sections,o=>(i(),r("div",{key:o.id,id:o.id,class:"tutorial-section"},[d("h2",null,m(o.title),1),U(et,{section:o},null,8,["section"])],8,lt))),128))]))),128))])])]))}}),ut=O(ct,[["__scopeId","data-v-e21ab759"]]);export{ut as default};
